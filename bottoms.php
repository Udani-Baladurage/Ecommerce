<!DOCTYPE html>
    ...
    <div class="cart">
        ...
        <img src="image/banner (1).jpg" class="banner-img">

            <div class="banner-overlay">
                <h1>BOTTOMS</h1>
                <p>Perfect Fit, Everyday Comfort</p>
            </div>
        </section>
        ...
        <section id="product" >
            ...
            <div class="product-container">
                ...
                <div class="pro product-box">
                    <img src="image/bottom16.jpg" alt="Product 1">
                    <div class="des">
                ...
                <div class="pro product-box">
                    <img src="image/bottom15.webp" alt="Product 1">
                    <div class="des">
                    <h5 class="product-title">	Midi Length Skirt With Panels With Pin Tucks</h5>
